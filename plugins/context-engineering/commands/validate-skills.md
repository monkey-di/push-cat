...
# /context-engineering:validate-skills

Validate all SKILL.md files in the project (or under `plugins/*/skills/` and `standalone/skills/` if this is the push-cat catalog) against the directive description format that ensures reliable skill activation.
